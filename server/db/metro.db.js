...
const LINES = [
  { id: 'L1', name_en: 'Line 1', name_fa: 'خط 1', color_hex: '#E31E24' }, // red
  { id: 'L2', name_en: 'Line 2', name_fa: 'خط 2', color_hex: '#233B8E' }, // dark blue
  { id: 'L3', name_en: 'Line 3', name_fa: 'خط 3', color_hex: '#00AEEF' }, // cyan
  { id: 'L4', name_en: 'Line 4', name_fa: 'خط 4', color_hex: '#F7D000' }, // yellow
];

// Helper for quick node creation
const S = (id, name_en, name_fa, x, y) => ({ id, name_en, name_fa, type: 'station', x, y });
const I = (id, name_en, name_fa, x, y) => ({ id, name_en, name_fa, type: 'intersection', x, y });
...
const NODES = [
  ...
  I('beheshti', 'Beheshti', 'بهشتی', 630, 325), // intersection (L1/L3)
  S('mofatteh', 'Mofatteh', 'مفتح', 630, 355),
  S('haftom-tir', 'Haftom Tir', 'هفتم تیر', 630, 390),
  S('taleghani', 'Taleghani', 'طالقانی', 630, 425),
  I('darvazeh-dowlat', 'Darvazeh Dowlat', 'دروازه دولت', 630, 460), // intersection (L1/L4)
  S('saadi', "Sa'di", 'سعدی', 630, 500),
  I('imam-khomeini', 'Imam Khomeini', 'امام خمینی', 630, 545), // intersection (L1/L2)
  ...
  I('darvazeh-shemiran', 'Darvazeh Shemiran', 'دروازه شمیران', 695, 460), // intersection (L2/L4)
  ...
  I('shademan', 'Shademan', 'شادمان', 460, 460), // intersection (L2/L4)
  ...
  I('teatr-shahr', 'Theatre Shahr', 'تئاتر شهر', 550, 460), // intersection (L3/L4)
...
const E = (id, a, b, line_id) => ({ id, from_node_id: a, to_node_id: b, line_id });

const EDGES = [
  // ---------------- L1 ----------------
  // E(101, 'tajrish',           'gheytariyeh'          'L1'),
  // E(102, 'gheytariyeh',       'sadr'                 'L1'),
  // E(103, 'sadr',              'gholhak'              'L1'),
  // E(104, 'gholhak',           'dr-shariati'          'L1'),
  // E(105, 'dr-shariati',       'mirdamad'             'L1'),
  // E(106, 'mirdamad',          'haghani'              'L1'),
  E(107, 'haghani',           'hemmat',                'L1'),
  E(108, 'hemmat',            'mosalla',               'L1'),
  E(109, 'mosalla',           'beheshti',              'L1'),
  E(110, 'beheshti',          'mofatteh',              'L1'),
  E(111, 'mofatteh',          'haftom-tir',            'L1'),
  E(112, 'haftom-tir',        'taleghani',             'L1'),
  E(113, 'taleghani',         'darvazeh-dowlat',       'L1'),
  E(114, 'darvazeh-dowlat',   'saadi',                 'L1'),
  E(115, 'saadi',             'imam-khomeini',         'L1'),
  E(116, 'imam-khomeini',     'panzdah-khordad',       'L1'),
  E(117, 'panzdah-khordad',   'khayyam',               'L1'),
  // E(118, 'khayyam',           'mohammadiyeh'         'L1'),
  // E(119, 'mohammadiyeh',      'shoush'               'L1'),
  // E(120, 'shoush',            'payane-jonoub'        'L1'),
  // E(121, 'payane-jonoub',     'shahr-rey'            'L1'),
  // E(122, 'shahr-rey',         'haram-motahhar'       'L1'),
  // E(123, 'haram-motahhar',    'kahrizak'             'L1'),

  // ---------------- L2 ----------------
  // E(201, 'farhangsara',       'tehranpars'           'L2'),
  // E(202, 'tehranpars',        'bagheri'              'L2'),
  // E(203, 'bagheri',           'elm-o-sanat'          'L2'),
  // E(204, 'elm-o-sanat',       'janbazan'             'L2'),
  // E(205, 'janbazan',          'fadaak'               'L2'),
  // E(206, 'fadaak',            'sabalan'              'L2'),
  // E(207, 'sabalan',           'madani'               'L2'),
  E(208, 'madani',            'emam-hossein',          'L2'),
  E(209, 'emam-hossein',      'darvazeh-shemiran',     'L2'),
  E(210, 'darvazeh-shemiran', 'baharestan',            'L2'),
  E(211, 'baharestan',        'mellat',                'L2'),
  E(212, 'mellat',            'imam-khomeini',         'L2'),
  E(213, 'imam-khomeini',     'hassan-abad',           'L2'),
  E(214, 'hassan-abad',       'horr',                  'L2'),
  E(215, 'horr',              'shademan',              'L2'),
  E(216, 'shademan',          'sharif-university',     'L2'),
  E(217, 'sharif-university', 'tarasht',               'L2'),
  E(218, 'tarasht',           'sadeghiyeh',            'L2'),

  // ---------------- L3 ----------------
  // E(301, 'ghaem',             'mahallati'            'L3'),
  // E(302, 'mahallati',         'aghdasieh'            'L3'),
  // E(303, 'aghdasieh',         'nobonyad'             'L3'),
  // E(304, 'nobonyad',          'hossein-abad'         'L3'),
  // E(305, 'hossein-abad',      'heravi'               'L3'),
  // E(306, 'heravi',            'zeynoddin'            'L3'),
  // E(307, 'zeynoddin',         'khajeh-abdollah-ansari' 'L3'),
  // E(308, 'khajeh-abdollah-ansari', 'sayyad-shirazi'  'L3'),
  E(309, 'sayyad-shirazi',    'ghoddoosi',             'L3'),
  E(310, 'ghoddoosi',         'sohrevardi',            'L3'),
  E(311, 'sohrevardi',        'beheshti',              'L3'),
  E(312, 'beheshti',          'mirza-ye-shirazi',      'L3'),
  E(313, 'mirza-ye-shirazi',  'jahad',                 'L3'),
  E(314, 'jahad',             'vali-asr',              'L3'),
  E(315, 'vali-asr',          'teatr-shahr',           'L3'),
  E(316, 'teatr-shahr',       'moniriyeh',             'L3'),
  E(317, 'moniriyeh',         'mahdiyeh',              'L3'),
  E(318, 'mahdiyeh',          'rahahan',               'L3'),
  // E(319, 'rahahan',           'azadegan'             'L3'),

  // ---------------- L4 ----------------
  // E(401, 'kolahdouz',         'nirou-havaei'         'L4'),
  // E(402, 'nirou-havaei',      'nabard'               'L4'),
  // E(403, 'nabard',            'pirouzi'              'L4'),
  E(404, 'pirouzi',           'shohada',               'L4'),
  E(405, 'shohada',           'darvazeh-shemiran',     'L4'),
  E(406, 'darvazeh-shemiran', 'darvazeh-dowlat',       'L4'),
  E(407, 'darvazeh-dowlat',   'ferdowsi',              'L4'),
  E(408, 'ferdowsi',          'teatr-shahr',           'L4'),
  E(409, 'teatr-shahr',       'enghelab',              'L4'),
  E(410, 'enghelab',          'towhid',                'L4'),
  E(411, 'towhid',            'shademan',              'L4'),
  E(412, 'shademan',          'dr-habibollah',         'L4'),
  E(413, 'dr-habibollah',     'ostad-moein',           'L4'),
  E(414, 'ostad-moein',       'azadi',                 'L4'),
  E(415, 'azadi',             'bimeh',                 'L4'),
  E(416, 'bimeh',             'mehrabad-t1-2',         'L4'),
  // E(417, 'mehrabad-t1-2',     'mehrabad-t4-6'        'L4'),
];
...
function seedMetro(db, metroSeed = TEHRAN_SEED) {
  const alreadySeeded = db.prepare('SELECT COUNT(*) AS n FROM metro_edge').get().n > 0;
  if (alreadySeeded) return;

  const tx = db.transaction(() => {
    const upsertLine = db.prepare(`
      INSERT INTO metro_line (id, name_en, name_fa, color_hex)
      VALUES (@id, @name_en, @name_fa, @color_hex)
    ...
    const insEdge = db.prepare(`
      INSERT INTO metro_edge (id, from_node_id, to_node_id, line_id)
      VALUES (?, ?, ?, ?);
    `);

    for (const e of metroSeed.EDGES) {
      insEdge.run(e.id, e.from_node_id, e.to_node_id, e.line_id);
    }
  });
...
function getMetroGraph(db) {
  const lines = db
    .prepare('SELECT id, name_en, name_fa, color_hex FROM metro_line ORDER BY id')
    .all();
  ...
  const edges = db
    .prepare(
      `SELECT id, from_node_id, to_node_id, line_id
       FROM metro_edge
       ORDER BY id`
    )
    .all();
